...
class TestCategory {
    ...
    public function getAll($exam_category_id = null, $user_id = null, $includeInactive = false) {
        ...
        // Filter by is_active unless includeInactive is true (for admin panel)
        if (!$includeInactive) {
            $query .= " WHERE tc.is_active = 1";
        } else {
            $query .= " WHERE 1=1";
        }
